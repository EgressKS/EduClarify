          ...
          <div className="max-w-md w-full bg-zinc-900 border border-zinc-700/50 rounded-2xl shadow-2xl p-8 relative">
            ...
            <div className="space-y-3 mb-6">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-zinc-800 border border-zinc-600 rounded-lg font-semibold text-white hover:bg-zinc-700 transition-all"
              >
